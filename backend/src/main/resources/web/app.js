...
var backendUrl = "https://team-bug.dokku.cse.lehigh.edu";
/**
    ...
    NewEntryForm.prototype.submitForm = function () {
        ...
        var doAjax = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(backendUrl, "/posts"), {
                            method: 'POST',
                            body: JSON.stringify({
                                mTitle: title,
                                mMessage: msg
...
var ElementList = /** @class */ (function () {
    ...
    ElementList.prototype.update = function (data) {
        ...
        for (var i = 0; i < all_likebtns.length; ++i) {
            ...
            //set like 
            if (data.mData[i].isLiked) {
                all_likebtns[i].classList.add("isLiked");
            }
            else {
                all_likebtns[i].classList.remove("isLiked");
            }
        }
    };
    /**
    ...
    ElementList.prototype.clickDelete = function (e) {
        ...
        var doAjax = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(backendUrl, "/posts/").concat(id), {
                            method: 'DELETE',
                            headers: {
                                'Content-type': 'application/json; charset=UTF-8'
                            }
    ...
    ElementList.prototype.clickLike = function (e) {
        ...
        var btn = e.target;
        var id = e.target.getAttribute("data-value");
        // Issue an AJAX POST to indicate liking the message
        var doAjax = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch("".concat(backendUrl, "/posts/").concat(id), {
        ...
        if (btn.classList.contains("heart-empty")) {
            ...
            btn.classList.remove("heart-filled");
    ...
    ElementList.prototype.buttons = function (id) {
        ...
        btn.setAttribute('data-value', id);
        // Use the heart symbol (❤) as the button text
